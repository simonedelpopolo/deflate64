...
export const help = Object.defineProperty( d64, helpSymbol, {
    ...
    value: async function help_( command, flag ){
        ...
        const helpFlags = () => {
            ...
            console.info( '         ', '\x1b[47m', '\x1b[39m', 'flags go two by two', '\x1b[0m' )
            console.info( '         ', '\x1b[47m', '\x1b[39m', 'That means that every flag passed to the command line must be followed by another argument.', '\x1b[0m' )
            console.info()
